    ...
    <div class="collapse navbar-collapse snipcss0-0-0-1" id="navcol-1">
      ...
      <ul class="nav navbar-nav navbar-right snipcss0-1-1-3">
        <li role="presentation" class="snipcss0-2-3-4">
          <a href="studentfeatures.jsp" class="smooth-scroll snipcss0-3-4-5">
            Features
          </a>
        </li>
        <li class="dropdown snipcss0-2-3-6">
          <a data-toggle="dropdown" aria-expanded="true" href="studentmaterial.jsp" class="dropdown-toggle snipcss0-3-6-7">
            Material
        ...
        <li class="dropdown snipcss0-2-3-6">
          <a href="quizes.jsp" class="dropdown-toggle snipcss0-3-6-7">
            Quizes
            <span class="caret snipcss0-4-7-8">
            </span>
          </a><a href="videos.jsp" class="dropdown-toggle snipcss0-3-6-7">
            videos
            <span class="caret snipcss0-4-7-8">
            </span>
          </a>
