  ...
  <div class="card-columns">
    ...
    <div class="card border-0">
      ...
      <div class="card-footer">
        <div class="media align-items-center">
          <div class="media-body"><a class="card-link text-primary read-more" href="readmore_e_education.jsp">Read More</a></div>
    ...
    <div class="card text-center border-0 mb-4">
      ...
      <div class="card-footer card-footer two">
        <a class="card-link text-primary read-more two" href="follow.jsp">Follow</a>
...
<!-- Footer-->
<footer class="footer">
  <p>Created by <a class="yo" href="https://codepen.io/hluebbering">LearnAlite</a> | 2024 </p>
